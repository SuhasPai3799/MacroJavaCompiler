...
public class Setup<R> extends GJNoArguDepthFirst<R>{
   //
  ...
  public R visit(NodeToken n) { return (R)""; }
   ...
   public R visit(ClassExtendsDeclaration n) {
      ...
      all_scope_vars.put(cl_name,new Vector());
      n.f2.accept(this);
      String parent_cl = (String)n.f3.accept(this);
   ...
   public R visit(MethodDeclaration n) {
      R _ret=null;
      n.f0.accept(this);
      String gg = (String)n.f1.accept(this);
   ...
   public R visit(FormalParameter n) {
      R _ret=null;
      String t = (String)n.f0.accept(this);
